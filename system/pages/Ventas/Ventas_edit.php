                                        ...
                                        <div class="col-sm-12" style="padding:0px">
                                            ...
                                            <div class="col-sm-6" style="padding:0px;padding-left: 10px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required class="form-control" id="codigo" name="codigo"  value="<?php echo $data['codinter']; ?>" placeholder="Codigo" onkeypress="nextFocus('codigo', 'nombre')">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
            ...
            for (var i = 0, f; f = files[i]; i++) {
                ...
                reader.onload = (function(theFile) {
                    return function(e) {
                        ...
                        span.innerHTML = ['<img title="click para eliminar" onclick="deleteimage(',num,');  return false;"  class="thumb" id="image_',num,'" max-width="150px" max-height="150px" src="', e.target.result,

...
$idtiendaant  = (isset($_POST['id_tiendaanterior'])) ? $_POST['id_tiendaanterior'] : $_SESSION['user_info']['id_tienda'];
$arrayfilters['fecha_inicial']     = $begin;
$arrayfilters['fecha_final']       = $end;
$arrayfilters['id_usuario']        = $idusuario;
$arrayfilters['id_tiendaanterior'] = $idtiendaant;
$arrayfilters['id_tienda']         = $idtienda;

$datasalidas = $objSalida->getReporteSalidas($arrayfilters);
...
<div id="main" role="main">
	...
	<div id="content">
		<section id="widget-grid" class="">
					...
					<div class="jarviswidget jarviswidget-color-white" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="true">
						...
						<div style="display: ;">
                            ...
                            <div class="widget-body">
								<form id="main-form" class="" role="form" method='post' action="<?php echo make_url("Salidas","index");?>" onsubmit="return checkSubmit();" enctype="multipart/form-data">     
                                    <fieldset>    
			...
			<?php if(isset($datasalidas) && $datasalidas!=''){ ?>
				<div class="row">
												...
												<tr class="<?php echo $class; ?>">
													<td>
														<a class="" href="<?php echo make_url("Salidas","view",array('id'=>$row['id_salida'])); ?>">
															<?php echo htmlentities($row['id_salida'])?>:Ver
														</a>
													</td>
													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																<li>
																	<a title="Ver Salida" class=""  href="<?php echo make_url("Salidas","view",array('id'=>$row['id_salida'])); ?>"> Ver Salida</a>
																</li>
																<li>
																	<a title="Imprimir Salida" class="" target="_blank" href="<?php echo make_url("Salidas","print",array('id'=>$row['id_salida'],'page'=>'salida')); ?>">Imprimir</a>
																</li>
																<?php 
																if ($row['status']!='BAJA'){ ?> 
																	<li class="divider"></li>
																	<li>
																		<a href="#" class="red" onclick="borrar('<?php echo make_url("Salidas","salidadelete",array('id'=>$row['id_salida'])); ?>',<?php echo $row['id_salida']; ?>);">Eliminar</a>
																	</li>
																<?php 
																} ?>
															</ul>

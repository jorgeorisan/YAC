...
if(isset($request['params']['id'])   && $request['params']['id']>0)
    ...
    informError(true,make_url("Traspaso","index"));
...
<div id="main" role="main">
    <?php $breadcrumbs["Traspasos"] = APP_URL."/Traspasos"; include(SYSTEM_DIR . "/inc/ribbon.php"); ?>
        ...
        <section id="widget-grid" class="">
			<div class="row">   
                <div class="widget-body" style='padding-left: 15px;'>
					<a class="btn btn-success" target="_blank" href="<?php echo make_url("Traspasos","print",array('id'=>$id,'page'=>'traspaso'))?>" ><i class="fa fa-print"></i> &nbsp;Imprimir</a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        validar = function(id_traspaso){
            var url = config.base+"/Traspasos/ajax/?action=get&object=validar"; 
            $.ajax({
                type: "POST",
                url: url,
                data: "id_traspaso="+id_traspaso, 

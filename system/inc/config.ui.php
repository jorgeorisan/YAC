...
$menuPacientes = array(
	"Pacientes" => array(
			...
			"icon" => "fa-users",
			"sub" => array(
				'clientsindex' => array('title'  => 'Pacientes','url' => APP_URL."/Pacientes/index" ),
				'clients' => array('title'  => 'Nuevo Paciente','url' => APP_URL."/Pacientes/add" )
			)
	)
);
$menuClientes = array(
...
$menuHistorial = array(
	"Historial" => array(
			...
			"icon" => "fa-list",
			"sub" => array(
				'historialindex' => array('title'  => 'Historial','url' => APP_URL."/Historial/index" ),
				'consultas' => array('title'  => 'Nueva consulta','url' => APP_URL."/Historial/consulta" )
			)
	)
);

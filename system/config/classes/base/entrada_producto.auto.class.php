<?php 
	...
	class AutoEntradaProducto {

	// Variables
		protected $db;
		
		protected $id_entrada_producto = 0;
	...
	// Constructor Methods
		...
		public static function construct( $id ){
			...
			$entradaProducto->setId( $id );
			return $entradaProducto;
		}
		public static function constructWithValues( $values ){
			$entradaProducto = new EntradaProducto();
			$entradaProducto->setValues( $values );
			return $entradaProducto;
		}


	// Setter Methods
		public function setIdEntradaProducto( $value ){			
			if ( $this->validclassateInput("/^.*$/", $value, "IDENTRADAPRODUCTO","i") ) 
 				$this->id_entrada_producto = $value;
		}
		...
		public function setIdEntrada( $value ){			
			if ( $this->validclassateInput("/^.*$/", $value, "IDENTRADA","i") ) 
 				$this->id_entrada = $value;
		}
	...
	// Getter Methods
		public function getIdEntradaProducto($sanitize=true){ 
 			if($sanitize){
 				return htmlspecialchars($this->id_entrada_producto) ;
 			}else{
 				return $this->id_entrada_producto ;
 			}
		}
		...
		public function getIdEntrada($sanitize=true){ 
 			if($sanitize){
 				return htmlspecialchars($this->id_entrada) ;
 			}else{
	...
	// Public Support Functions
		public function load($id) {
			$sql="SELECT * FROM entrada_producto WHERE id = ?";
			...
			$this->setIdEntradaProducto( $res['id_entrada_producto'] );
			...
			$this->setIdEntrada( $res['id_entrada'] );

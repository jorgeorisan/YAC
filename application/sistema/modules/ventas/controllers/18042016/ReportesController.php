...
*/
        ...
        if ( $this->_request->getParam("id_tienda")&&  $this->_request->getParam("id_usuario")) {
            $query->andWhere("id_tienda = ?", $this->_request->getParam("id_tienda"));
            $query->andWhere("id_usuario = ?", $this->_request->getParam("id_usuario"));
        }
...
//echo $query2->getSqlQuery();//imprime la consulta qu ese esta generando
        ...
        foreach ($idsusuario as $key => $val) {
            ...
            $iObj->descgastos = $descgastos[$key];

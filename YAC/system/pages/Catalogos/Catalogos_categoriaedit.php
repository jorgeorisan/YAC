...
if(isPost()){
    ...
    if( $id  ) {
        ...
        informError(true, make_url("Catalogos","categoriaedit",array('id'=>$id)),"categoriaedit");
    }
}
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
                    ...
                    data-widget-deletebutton="false" data-widget-collapsed="false">
                        ...
                        <div style="display: ;">
                            ...
                            <div class="widget-body">
                                <form id="main-form" class="" role="form" method=post action="<?php echo make_url("Catalogos","categoriaedit",array('id'=>$id));?>" onsubmit="return checkSubmit();" enctype="multipart/form-data">
                                   <div class="tl-body">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="name">Nombre</label>
                                                <input type="text" class="form-control" placeholder="Nombre categoria" name="categoria" value="<?php echo htmlentities($data['categoria']); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">

...
$page_nav["forms"]["sub"]["smart_elements"]["active"] = true;
	...
	<div id="content">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<p>
					You can explore some of the <a href="<?php echo APP_URL; ?>/form-templates.php" title="Go to Bootstrap Forms">layouts</a> made using Smart Forms grid system or if you are not comfortable with this grid system you can simply stick to the default <a href="<?php echo APP_URL; ?>/bootstrap-forms.php" title="Go to Bootstrap Forms">Bootstrap forms</a> 
				</p>
				</div>
